...
// (difference of 1). From your 1-jolt rated adapter, the only choice is your
// 4-jolt rated adapter (difference of 3). From the 4-jolt rated adapter, the
// adapters rated 5, 6, or 7 are valid choices. However, in order to not skip
...
// the adapter rated 7 (with difference of 1 and 1). The only adapter that
// works with the 7-jolt rated adapter is the one rated 10 jolts (difference of
// 3). From 10, the choices are 11 or 12; choose 11 (difference of 1) and then
// 12 (difference of 1). After 12, only valid adapter has a rating of 15
// (difference of 3), then 16 (difference of 1), then 19 (difference of 3).
...
module.exports = (inputs) => {
  const adapters = inputs.sort((a, b) => a - b);
  let last = 0;
  let ones = 0;
  // There is always one final jump of three
  let threes = 1;
