...
// 2 to their score (for a total score of 2). The game immediately ends as a
...
module.exports = (inputs) => {
  ...
  while (true) {
    loc1 = (loc1 + roll() + roll() + roll()) % 10 || 10;
    score1 += loc1;
    ...
    loc2 = (loc2 + roll() + roll() + roll()) % 10 || 10;
    score2 += loc2;
